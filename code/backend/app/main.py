...
app=FastAPI(title=settings.app_name,version="0.3.0",description="NABU Personal Operating System API")
app.add_middleware(CORSMiddleware,allow_origins=settings.cors_list,allow_credentials=True,allow_methods=["*"],allow_headers=["*"])

@app.get("/health")
def health(): return {"status":"ok","service":"nabu-api","version":"0.3.0"}
